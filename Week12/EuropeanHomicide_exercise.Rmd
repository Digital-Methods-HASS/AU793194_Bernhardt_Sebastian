...
knitr::opts_chunk$set(echo = TRUE,
                      message=FALSE)
```
#  Exploring Homicide rates in NW Europe
...
## Viewing the long-term trend in homicides
...
## The homicides of individual countries
...
Western_Europe %>% 
  ggplot(aes(x = Year, y = homicides_per_100k, color=Countries))+
  geom_line()+
  labs(title = "Historical homicides in Western Europe",
       x = "Year",
...
ggsave("homicides.png", width =14, height =6, dpi= 100)
```
...
- How would you characterize the trend compared to the homicides above?
  It was more common to get killed before than today


```{r eval = TRUE}
# YOUR CODE HERE:
read_csv2("data/Den danske konrække_csv (1).csv")
...
- The visualizations show a steady decline in homicide rates in Western Europe from the Middle Ages to the present day. In countries such as England, Italy, and the Netherlands, rates have fallen from around 20–70 homicides per 100,000 inhabitants to about 1 or lower today. This suggests a long-term and substantial reduction in interpersonal violence, meaning that violence plays a much smaller role in everyday life than before. 

With some caution taken, this supports the idea that societies have become more “civilized.” Civilization can be understood as a development of social norms, institutions, and self-control that reduce violent behavior. The decline in homicide rates may be linked to the rise of stronger states, more effective legal systems, and greater trust among citizens. This is also reflected in the second visualization, where kings rule for longer periods and there are fewer short reigns. This indicates greater political stability and fewer violent power struggles. 

Together, the two graphs suggest a general movement toward less violence and more stable societies. Overall, the data show that violence has decreased significantly, supporting the argument that societies today are more civilized, at least in terms of reduced everyday violence. 